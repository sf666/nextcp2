...
public class JdkHttpServerUpnpStream extends UpnpStream
{
    ...
    private static final String SERVER_HTTP_TOKEN = new ServerClientTokens("UMS", "2.4").getHttpToken();
    ...
    public void run()
    {
        try
        {
            ...
            // Status
            StreamRequestMessage requestMessage = new StreamRequestMessage(UpnpRequest.Method.getByHttpName(getHttpExchange().getRequestMethod()),
