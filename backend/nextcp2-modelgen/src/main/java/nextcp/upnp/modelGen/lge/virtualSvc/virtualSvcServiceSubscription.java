package nextcp.upnp.modelGen.lge.virtualSvc;
 ...
 */
public class virtualSvcServiceSubscription extends RemoteGENASubscription
{
    private static final Logger log = LoggerFactory.getLogger(virtualSvcServiceSubscription.class.getName());

    private List<IvirtualSvcServiceEventListener> eventListener = new CopyOnWriteArrayList<>();
        
    protected virtualSvcServiceSubscription(RemoteService service, int requestedDurationSeconds)
    {
    ...
    {
        for (IvirtualSvcServiceEventListener listener : eventListener)
        {
