 ...
 *  
 */
public class GetPlexCode extends ActionCallback
{
    private static Logger log = LoggerFactory.getLogger(GetPlexCode.class.getName());
    ...
    public GetPlexCodeOutput executeAction()
    {
        ...
        GetPlexCodeOutput result = new GetPlexCodeOutput();
