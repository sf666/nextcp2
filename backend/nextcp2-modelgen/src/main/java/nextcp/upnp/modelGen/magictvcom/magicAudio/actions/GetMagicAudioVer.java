 ...
 */
public class GetMagicAudioVer extends ActionCallback
{
    private static Logger log = LoggerFactory.getLogger(GetMagicAudioVer.class.getName());
    ...
    public GetMagicAudioVerOutput executeAction()
    {
        ...
        GetMagicAudioVerOutput result = new GetMagicAudioVerOutput();
