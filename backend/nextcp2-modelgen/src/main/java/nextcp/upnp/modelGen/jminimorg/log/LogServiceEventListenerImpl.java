 ...
 */
public class LogServiceEventListenerImpl implements ILogServiceEventListener 
{
    private static Logger log = LoggerFactory.getLogger(LogService.class.getName());
    private LogServiceStateVariable stateVariable = new LogServiceStateVariable();
     ...
     */
    public LogServiceStateVariable getStateVariable()
    {
