 ...
 */
public class Monitor2ServiceSubscription extends RemoteGENASubscription
{
    private static final Logger log = LoggerFactory.getLogger(Monitor2ServiceSubscription.class.getName());

    private List<IMonitor2ServiceEventListener> eventListener = new CopyOnWriteArrayList<>();
        
    protected Monitor2ServiceSubscription(RemoteService service, int requestedDurationSeconds)
    {
    ...
    {
        for (IMonitor2ServiceEventListener listener : eventListener)
        {
