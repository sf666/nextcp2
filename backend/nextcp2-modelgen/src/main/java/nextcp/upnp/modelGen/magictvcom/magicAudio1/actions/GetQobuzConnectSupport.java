 ...
 *  
 */
public class GetQobuzConnectSupport extends ActionCallback
{
    private static Logger log = LoggerFactory.getLogger(GetQobuzConnectSupport.class.getName());
    ...
    public GetQobuzConnectSupportOutput executeAction()
    {
        ...
        GetQobuzConnectSupportOutput result = new GetQobuzConnectSupportOutput();
