 ...
 */
public class GetAutoPlay extends ActionCallback
{
    private static Logger log = LoggerFactory.getLogger(GetAutoPlay.class.getName());
    ...
    public GetAutoPlayOutput executeAction()
    {
        ...
        GetAutoPlayOutput result = new GetAutoPlayOutput();
