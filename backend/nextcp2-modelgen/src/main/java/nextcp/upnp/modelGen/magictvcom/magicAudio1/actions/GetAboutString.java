 ...
 *  
 */
public class GetAboutString extends ActionCallback
{
    private static Logger log = LoggerFactory.getLogger(GetAboutString.class.getName());
    ...
    public GetAboutString(Service service, GetAboutStringInput input, ControlPoint cp)
    {
        ...
        getActionInvocation().setInput("Lang", UpnpValue.forInput(getActionInvocation(), "Lang", input.Lang));
    }
    ...
    public GetAboutStringOutput executeAction()
    {
        ...
        GetAboutStringOutput result = new GetAboutStringOutput();
