 ...
 */
public class webosSecondScreenServiceEventListenerImpl implements IwebosSecondScreenServiceEventListener 
{
    private static Logger log = LoggerFactory.getLogger(webosSecondScreenServiceEventListenerImpl.class.getName());
    private webosSecondScreenServiceStateVariable stateVariable = new webosSecondScreenServiceStateVariable();
    private RemoteDevice device = null;
    
    
	public webosSecondScreenServiceEventListenerImpl(RemoteDevice device) {
		this.device = device;
	}
     ...
     */
    public webosSecondScreenServiceStateVariable getStateVariable()
    {
    ...
    // =============================================================================================================================================================================
    public void x_PlaceHolderChange(String value)
    {
        stateVariable.X_PlaceHolder = value;
        if (log.isDebugEnabled())
        {
            log.debug(String.format("StateVariable : %s: %s", "X_PlaceHolder", value));
        }
    }
