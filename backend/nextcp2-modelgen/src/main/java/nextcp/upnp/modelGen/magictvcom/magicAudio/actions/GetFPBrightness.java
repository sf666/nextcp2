 ...
 *  
 */
public class GetFPBrightness extends ActionCallback
{
    private static Logger log = LoggerFactory.getLogger(GetFPBrightness.class.getName());
    ...
    public GetFPBrightnessOutput executeAction()
    {
        ...
        GetFPBrightnessOutput result = new GetFPBrightnessOutput();
