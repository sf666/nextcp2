...
public class ReadList extends ActionCallback
{
    ...
    public ReadList(Service service, ReadListInput input, ControlPoint cp)
    {
        ...
        getActionInvocation().setInput("IdList", UpnpValue.forInput(getActionInvocation(), "IdList", input.IdList));
    }
    ...
    public ReadListOutput executeAction()
    {
        ...
        result.ChannelList = UpnpValue.toTextOrEmpty(invocation.getOutput("ChannelList").getValue());
