 ...
 */
public class ScreenSharingServiceServiceEventListenerImpl implements IScreenSharingServiceServiceEventListener 
{
    private static Logger log = LoggerFactory.getLogger(ScreenSharingServiceService.class.getName());
    private ScreenSharingServiceServiceStateVariable stateVariable = new ScreenSharingServiceServiceStateVariable();
     ...
     */
    public ScreenSharingServiceServiceStateVariable getStateVariable()
    {
    ...
    // =============================================================================================================================================================================
    public void screenSharingStateChange(String value)
    {
        stateVariable.ScreenSharingState = value;
        if (log.isDebugEnabled())
        {
            log.debug(String.format("StateVariable : %s: %s", "ScreenSharingState", value));
        }
    }
