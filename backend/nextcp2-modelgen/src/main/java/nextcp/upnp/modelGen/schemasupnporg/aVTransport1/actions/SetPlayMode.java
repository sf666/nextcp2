 ...
 *  
 */
public class SetPlayMode extends ActionCallback
{
    ...
    public SetPlayMode(Service service, SetPlayModeInput input, ControlPoint cp)
    {
        ...
        getActionInvocation().setInput("NewPlayMode", UpnpValue.forInput(getActionInvocation(), "NewPlayMode", input.NewPlayMode));
    }
