 ...
 */
public class GetPlaybackClockSource extends ActionCallback
{
    private static Logger log = LoggerFactory.getLogger(GetPlaybackClockSource.class.getName());
    ...
    public GetPlaybackClockSourceOutput executeAction()
    {
        ...
        GetPlaybackClockSourceOutput result = new GetPlaybackClockSourceOutput();
