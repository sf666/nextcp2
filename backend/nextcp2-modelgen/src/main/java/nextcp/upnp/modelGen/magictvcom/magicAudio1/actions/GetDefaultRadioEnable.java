 ...
 *  
 */
public class GetDefaultRadioEnable extends ActionCallback
{
    private static Logger log = LoggerFactory.getLogger(GetDefaultRadioEnable.class.getName());
    ...
    public GetDefaultRadioEnableOutput executeAction()
    {
        ...
        GetDefaultRadioEnableOutput result = new GetDefaultRadioEnableOutput();
