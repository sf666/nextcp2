 ...
 */
public class webos-second-screenServiceEventListenerImpl implements Iwebos-second-screenServiceEventListener 
{
    private static Logger log = LoggerFactory.getLogger(webos-second-screenService.class.getName());
    private webos-second-screenServiceStateVariable stateVariable = new webos-second-screenServiceStateVariable();
     ...
     */
    public webos-second-screenServiceStateVariable getStateVariable()
    {
