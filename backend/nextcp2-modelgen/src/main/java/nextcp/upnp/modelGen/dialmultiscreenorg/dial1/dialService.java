...
//    private dialServiceStateVariable dialServiceStateVariable = new dialServiceStateVariable();
     ...
     */
    public dialService(UpnpService upnpService, RemoteDevice device, IdialServiceEventListener listener)
    {
    ...
    {
        return dialService != null && dialService.getAction(actionName) != null;
    }
