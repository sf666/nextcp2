 ...
 *  
 */
public class GetKKBOXEnable extends ActionCallback
{
    private static Logger log = LoggerFactory.getLogger(GetKKBOXEnable.class.getName());
    ...
    public GetKKBOXEnableOutput executeAction()
    {
        ...
        GetKKBOXEnableOutput result = new GetKKBOXEnableOutput();
