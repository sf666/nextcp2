 ...
 */
public class GetOutputClockSource extends ActionCallback
{
    private static Logger log = LoggerFactory.getLogger(GetOutputClockSource.class.getName());
    ...
    public GetOutputClockSourceOutput executeAction()
    {
        ...
        GetOutputClockSourceOutput result = new GetOutputClockSourceOutput();
