 ...
 */
public class MonitorServiceEventListenerImpl implements IMonitorServiceEventListener 
{
    private static Logger log = LoggerFactory.getLogger(MonitorService.class.getName());
    private MonitorServiceStateVariable stateVariable = new MonitorServiceStateVariable();
     ...
     */
    public MonitorServiceStateVariable getStateVariable()
    {
