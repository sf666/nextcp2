...
public class SetHorizontalKeystone extends ActionCallback
{
    ...
    public SetHorizontalKeystone(Service service, SetHorizontalKeystoneInput input, ControlPoint cp)
    {
        ...
        getActionInvocation().setInput("DesiredHorizontalKeystone", UpnpValue.forInput(getActionInvocation(), "DesiredHorizontalKeystone", input.DesiredHorizontalKeystone));
