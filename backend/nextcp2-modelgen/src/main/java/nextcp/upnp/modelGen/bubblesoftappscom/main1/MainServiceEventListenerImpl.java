 ...
 */
public class MainServiceEventListenerImpl implements IMainServiceEventListener 
{
    private static Logger log = LoggerFactory.getLogger(MainServiceEventListenerImpl.class.getName());
    private MainServiceStateVariable stateVariable = new MainServiceStateVariable();
    private RemoteDevice device = null;
    
    
	public MainServiceEventListenerImpl(RemoteDevice device) {
		this.device = device;
	}
     ...
     */
    public MainServiceStateVariable getStateVariable()
    {
