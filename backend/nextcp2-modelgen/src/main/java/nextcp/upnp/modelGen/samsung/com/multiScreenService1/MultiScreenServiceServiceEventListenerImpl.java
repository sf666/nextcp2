 ...
 */
public class MultiScreenServiceServiceEventListenerImpl implements IMultiScreenServiceServiceEventListener 
{
    private static Logger log = LoggerFactory.getLogger(MultiScreenServiceServiceEventListenerImpl.class.getName());
    private MultiScreenServiceServiceStateVariable stateVariable = new MultiScreenServiceServiceStateVariable();
    private RemoteDevice device = null;
    
    
	public MultiScreenServiceServiceEventListenerImpl(RemoteDevice device) {
		this.device = device;
	}
     ...
     */
    public MultiScreenServiceServiceStateVariable getStateVariable()
    {
