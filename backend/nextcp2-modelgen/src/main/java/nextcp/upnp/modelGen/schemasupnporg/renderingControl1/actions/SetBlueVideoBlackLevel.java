...
public class SetBlueVideoBlackLevel extends ActionCallback
{
    ...
    public SetBlueVideoBlackLevel(Service service, SetBlueVideoBlackLevelInput input, ControlPoint cp)
    {
        ...
        getActionInvocation().setInput("DesiredBlueVideoBlackLevel", UpnpValue.forInput(getActionInvocation(), "DesiredBlueVideoBlackLevel", input.DesiredBlueVideoBlackLevel));
