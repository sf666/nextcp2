...
public class QPlayServiceEventListenerImpl implements IQPlayServiceEventListener 
{
    ...
    private QPlayServiceStateVariable stateVariable = new QPlayServiceStateVariable();
     ...
     */
    public QPlayServiceStateVariable getStateVariable()
    {
    ...
    // =============================================================================================================================================================================
    public void fakeStateChange(Long value)
    {
        stateVariable.FakeState = value;
        if (log.isDebugEnabled())
        {
            log.debug(String.format("StateVariable : %s: %s", "FakeState", value));
        }
    }
