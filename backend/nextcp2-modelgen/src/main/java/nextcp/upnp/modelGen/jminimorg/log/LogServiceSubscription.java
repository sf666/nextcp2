 ...
 */
public class LogServiceSubscription extends RemoteGENASubscription
{
    private static final Logger log = LoggerFactory.getLogger(LogServiceSubscription.class.getName());

    private List<ILogServiceEventListener> eventListener = new CopyOnWriteArrayList<>();
        
    protected LogServiceSubscription(RemoteService service, int requestedDurationSeconds)
    {
    ...
    {
        for (ILogServiceEventListener listener : eventListener)
        {
