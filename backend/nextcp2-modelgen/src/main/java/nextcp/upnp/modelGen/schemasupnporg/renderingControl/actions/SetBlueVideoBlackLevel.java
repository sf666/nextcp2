...
public class SetBlueVideoBlackLevel extends ActionCallback
{
    ...
    {
        super(new ActionInvocation(service.getAction("SetBlueVideoBlackLevel")), cp);

        getActionInvocation().setInput("InstanceID", new UnsignedIntegerFourBytes(input.InstanceID));
        getActionInvocation().setInput("DesiredBlueVideoBlackLevel", new UnsignedIntegerFourBytes(input.DesiredBlueVideoBlackLevel));
    }
