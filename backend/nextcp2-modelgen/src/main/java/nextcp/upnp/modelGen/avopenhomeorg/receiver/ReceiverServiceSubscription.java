 ...
 */
public class ReceiverServiceSubscription extends RemoteGENASubscription
{
    private static final Logger log = LoggerFactory.getLogger(ReceiverServiceSubscription.class.getName());

    private List<IReceiverServiceEventListener> eventListener = new CopyOnWriteArrayList<>();
        
    protected ReceiverServiceSubscription(RemoteService service, int requestedDurationSeconds)
    {
    ...
    {
        for (IReceiverServiceEventListener listener : eventListener)
        {
