 ...
 */
public class MultiScreenServiceServiceSubscription extends RemoteGENASubscription
{
    private static final Logger log = LoggerFactory.getLogger(MultiScreenServiceServiceSubscription.class.getName());

    private List<IMultiScreenServiceServiceEventListener> eventListener = new CopyOnWriteArrayList<>();
        
    protected MultiScreenServiceServiceSubscription(RemoteService service, int requestedDurationSeconds)
    {
