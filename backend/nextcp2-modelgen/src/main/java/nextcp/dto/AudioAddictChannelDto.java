...
public class AudioAddictChannelDto
{
    ...
    public AudioAddictChannelDto(Integer tracklistServerId, Integer id, String key, String name, String streamUrl, String descLong, String descShort, String albumArt)
    {
