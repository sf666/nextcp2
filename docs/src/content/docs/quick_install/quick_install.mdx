...
with systemd service manager installed a service template <a href="https://github.com/sf666/nextcp2/tree/main/startup-services/systemd">
  can be downloaded here
      ...
      change property <code>embeddedServerPort</code> to an available port. Further configuration can be done within the application itself. Please refer to
      <a href="https://github.com/sf666/nextcp2">GitHub</a> for detailed configuration documentation.
