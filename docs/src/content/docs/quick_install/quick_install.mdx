...
with systemd service manager installed a service template <a href="https://github.com/sf666/nextcp2/tree/main/startup-services/systemd"> can be downloaded here
...
Prefer a self-contained app that needs no separate Java installation? The release also ships native desktop apps (macOS `.dmg`, Windows `.msi`, portable app images) and a Docker image — see [Native builds](/nextcp2/quick_install/native_builds/).
