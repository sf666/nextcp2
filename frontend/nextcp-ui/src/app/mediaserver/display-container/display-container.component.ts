...
@Component({
    ...
    standalone: true,
    imports: [DomChangedDirective, NgIf, MatButton, MatIcon, MatFormField, MatLabel, MatPrefix, MatInput, FormsModule, MatSuffix, MatSelect, ReactiveFormsModule, MatOption, NgFor, QualityBadgeComponent, StarRatingComponent]
})
