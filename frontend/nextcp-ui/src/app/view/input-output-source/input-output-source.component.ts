...
@Component({
  selector: 'app-input-output-source',
  templateUrl: './input-output-source.component.html',
  styleUrls: ['./input-output-source.component.scss']
})
export class InputOutputSourceComponent {
